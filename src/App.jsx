...
// ─── PROJECTS ─────────────────────────────────────────────────────────────────
// Each project has 4 independent links — add/leave blank as needed:
//   YouTube_Link  → opens YouTube video in a new tab
//   Drive_Link    → opens Google Drive file in a new tab
//   GitHub_Link   → opens GitHub repo in a new tab
//   LinkedIn_Link → opens LinkedIn post in a new tab
const PROJECTS = [
  {
    id: 1, Category: "ML",
    ...
    Description:
      "Optimized 10K+ records with XGBoost and LightGBM, increasing model accuracy by 18% and dataset reliability by 30%.",
    Tech_Stack: "Python,XGBoost,LightGBM,Scikit-Learn,Pandas,NumPy",
    YouTube_Link:  "",   // ← paste YouTube video URL e.g. https://youtu.be/xxxx
    ...
    LinkedIn_Link: "",   // ← paste LinkedIn post URL
  },
  {
    id: 2, Category: "ML",
    ...
    Description:
      "Cleaned 13,320 records with PPS outlier removal. Built a Scikit-Learn Ridge Regression pipeline achieving 82% prediction accuracy across 240+ urban locations.",
...
// ─── PROJECT CARD — 4 independent action buttons ──────────────────────────────
function ProjectCard({ project, T }) {
  ...
  // helper: open link in new tab (does nothing if blank/missing)
  const open = (url) => { if (url && url !== "#") window.open(url, "_blank", "noopener,noreferrer"); };

  // button configs — each is fully independent
  const BTNS = [
    {
      key: "yt",
      label: "YouTube",
      ...
      activeColor:  "#ff0000",
      activeBg:     "#ff000014",
      activeBorder: "#ff000035",
      tooltip: "Watch video presentation on YouTube",
    },
    {
      key: "drive",
      label: "Drive File",
      ...
      activeColor:  "#1fa463",
      activeBg:     "#1fa46314",
      activeBorder: "#1fa46335",
      tooltip: "Open project file on Google Drive",
    },
    {
      key: "gh",
      label: "GitHub",
    ...
    },
    {
      ...
      label: "LinkedIn",
      icon: <IcLI />,
      url: project.LinkedIn_Link,
      activeColor:  "#0a66c2",
      activeBg:     "#0a66c214",
      activeBorder: "#0a66c235",
      tooltip: "View LinkedIn post",
    },
  ];
  ...
  useEffect(() => {
    ...
    fetch(GOOGLE_SHEET_CSV_URL)
      ...
      .then(csv => {
        ...
        const headers = hdr.split(",").map(h => h.trim().replace(/"/g, ""));
        const parsed = rows.map((line, i) => {
          const vals = line.split(",").map(v => v.trim().replace(/"/g, ""));
          return headers.reduce((o, h, j) => { o[h] = vals[j] || ""; return o; }, { id: i + 100 });
        });
      ...
      <div id="root-wrap" style={{
          ...
          <div className="hero-grid" style={{
            ...
            <div>
              ...
              <div className="anim-4 hero-btns" style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                ...
                <a href="./KEDAR_DS.pdf" download style={{
                  padding: "11px 28px", borderRadius: 9,
            ...
            <div className="two-col" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "start" }}>
              <Reveal delay={0.05}>
                ...
                <div style={{
                  ...
                  background: dark ? "#fbbf240c" : "#fef9c3",
                  border: `1px solid ${dark ? "#fbbf2430" : "#fde68a"}`,
                }}>
                  <span style={{ color: "#d97706", fontWeight: 700, fontSize: 13 }}>🏆 CIO District Winner</span>
                  <p style={{ color: T.muted, fontSize: 12, marginTop: 3 }}>National Level Computing Intelligence Olympiad</p>
                </div>
              </Reveal>
        ...
        <section id="projects" style={{ padding: "80px 48px" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            ...
            <Reveal delay={0.1}>
              <p style={{ color: T.dim, fontSize: 11, marginTop: 20, textAlign: "center" }}>
                Additional projects load from your Google Sheet automatically
              </p>
            </Reveal>
          </div>
        </section>
        ...
        <footer style={{
          ...
          <div style={{
            ...
            <p style={{ fontSize: 10, color: T.dim }}>
              © 2026 Kedar Limbalkar · Google Sheets CMS · EmailJS · React
            </p>
          </div>
        </footer>
